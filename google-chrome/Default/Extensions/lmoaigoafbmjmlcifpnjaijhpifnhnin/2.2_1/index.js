function onDocumentLoad() {
    ...
    document.onkeydown = function(evt) {
        ...
        if (evt.keyCode == 32 || evt.keyCode == 38) {
            ...
            if (!window.isPlayed) {
                ...
                if (document.getElementById('audio-batman')) {
                    setTimeout(function() {
                        document.getElementById('audio-batman').play();
                    }, 500)
                }
    ...
    t.config = {
        ...
        loadImages: function() {           
            ...
            var resourceId1 = 'offline-resources-1x';
            var resourceId2 = 'offline-resources-2x';
